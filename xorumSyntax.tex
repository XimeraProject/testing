...
%% May lose history of comments - not a big deal.
%% EG: I write a comment, with down-vote, then the answer is fixed, so I change the down-vote to an up-vote, and give a new comment. ``Nice work!''
